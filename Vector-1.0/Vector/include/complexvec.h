...
// operator + : add
static finline Complex2f operator + (Complex2f const & a, Complex2f const & b) {
    return Complex2f(Vec4f(a) + Vec4f(b));
}

// operator += : add
static finline Complex2f & operator += (Complex2f & a, Complex2f const & b) {
    a = a + b;
    return a;
}
...
static finline Complex2f operator - (Complex2f const & a) {
...
static finline bool operator == (Complex2f const & a, Complex2f const & b) {
...
// operator + : add
static finline Complex2f operator + (Complex2f const & a, float b) {
    return _mm_add_ss(a, _mm_set_ss(b));
}
static finline Complex2f operator + (float a, Complex2f const & b) {
    return b + a;
}
static finline Complex2f & operator += (Complex2f & a, float & b) {
    a = a + b;
    return a;
}
...
static finline float abs(Complex2f const & a) {
    Vec4f a1 = Vec4f(a);
    Vec4f a2 = a1 * a1;
#if  INSTRSET >= 3  // SSE3
...
static finline Complex2f sqrt(Complex2f const & a) {
...
// function select
static finline Complex2f select (bool s, Complex2f const & a, Complex2f const & b) {
    return s ? a : b;
}
...
// operator + : add
static finline Complex4f operator + (Complex4f const & a, Complex4f const & b) {
    return Complex4f(Vec4f(a) + Vec4f(b));
}

// operator += : add
static finline Complex4f & operator += (Complex4f & a, Complex4f const & b) {
    a = a + b;
    return a;
}
...
// operator - : unary minus
static finline Complex4f operator - (Complex4f const & a) {
...
// operator == : returns true if a == b
static finline Vec2db operator == (Complex4f const & a, Complex4f const & b) {
    Vec4fb t1 = Vec4f(a) == Vec4f(b);
...
// operator + : add
static finline Complex4f operator + (Complex4f const & a, float b) {
    return a + Complex4f(b);
}
static finline Complex4f operator + (float a, Complex4f const & b) {
    return b + a;
}
static finline Complex4f & operator += (Complex4f & a, float & b) {
    a = a + b;
    return a;
}
...
// function abs: absolute value
// abs(a,b) = sqrt(a*a+b*b);
static finline Complex4f abs(Complex4f const & a) {
    Vec4f a1 = Vec4f(a);
    Vec4f a2 = a1 * a1;
...
// function sqrt: square root
static finline Complex4f sqrt(Complex4f const & a) {
    __m128 t1  = _mm_mul_ps(a,a);             // r*r, i*i
    __m128 t2  = _mm_shuffle_ps(t1,t1,0xB1);  // swap real and imaginary parts
    __m128 t3  = _mm_add_ps(t1,t2);           // pairwise horizontal sum
    __m128 t4  = _mm_sqrt_ps(t3);             // n = sqrt(r*r+i*i)
...
// function select
static finline Complex4f select (Vec2db const & s, Complex4f const & a, Complex4f const & b) {
...
// operator + : add
static finline Complex8f operator + (Complex8f const & a, Complex8f const & b) {
    return Complex8f(Vec8f(a) + Vec8f(b));
}

// operator += : add
static finline Complex8f & operator += (Complex8f & a, Complex8f const & b) {
    a = a + b;
    return a;
}
...
// operator - : unary minus
static finline Complex8f operator - (Complex8f const & a) {
...
// operator == : returns true if a == b
static finline Vec4db operator == (Complex8f const & a, Complex8f const & b) {
...
// operator + : add
static finline Complex8f operator + (Complex8f const & a, float b) {
    return a + Complex8f(b);
}
static finline Complex8f operator + (float a, Complex8f const & b) {
    return b + a;
}
static finline Complex8f & operator += (Complex8f & a, float & b) {
    a = a + b;
    return a;
}
...
// function abs: absolute value
// abs(a,b) = sqrt(a*a+b*b);
static finline Complex8f abs(Complex8f const & a) {
#if INSTRSET >= 7  // AVX
    Vec8f a1 = Vec8f(a);
    Vec8f a2 = a1 * a1;
...
// function sqrt: square root
static finline Complex8f sqrt(Complex8f const & a) {
#if INSTRSET >= 7  // AVX
...
static finline Complex8f select (Vec4db const & s, Complex8f const & a, Complex8f const & b) {
...
// operator + : add
static finline Complex2d operator + (Complex2d const & a, Complex2d const & b) {
    return Complex2d(Vec2d(a) + Vec2d(b));
}

// operator += : add
static finline Complex2d & operator += (Complex2d & a, Complex2d const & b) {
    a = a + b;
    return a;
}
...
// operator - : unary minus
static finline Complex2d operator - (Complex2d const & a) {
...
// operator == : returns true if a == b
static finline bool operator == (Complex2d const & a, Complex2d const & b) {
...
// operator + : add
static finline Complex2d operator + (Complex2d const & a, double b) {
    return _mm_add_sd(a, _mm_set_sd(b));
}
static finline Complex2d operator + (double a, Complex2d const & b) {
    return b + a;
}
static finline Complex2d & operator += (Complex2d & a, double & b) {
    a = a + b;
    return a;
}
...
// function abs: absolute value
// abs(a,b) = sqrt(a*a+b*b);
static finline double abs(Complex2d const & a) {
    Vec2d t = Vec2d(a);
    return sqrt(horizontal_add(t*t));
}

// function sqrt: square root
static finline Complex2d sqrt(Complex2d const & a) {
...
// function select
static finline Complex2d select (bool s, Complex2d const & a, Complex2d const & b) {
    return s ? a : b;
}
...
// operator + : add
static finline Complex4d operator + (Complex4d const & a, Complex4d const & b) {
    return Complex4d(Vec4d(a) + Vec4d(b));
}

// operator += : add
static finline Complex4d & operator += (Complex4d & a, Complex4d const & b) {
    a = a + b;
    return a;
}
...
// operator - : unary minus
static finline Complex4d operator - (Complex4d const & a) {
...
// operator == : returns true if a == b
static finline Vec4db operator == (Complex4d const & a, Complex4d const & b) {
...
// operator + : add
static finline Complex4d operator + (Complex4d const & a, double b) {
    return a + Complex4d(b);
}
static finline Complex4d operator + (double a, Complex4d const & b) {
    return b + a;
}
static finline Complex4d & operator += (Complex4d & a, double & b) {
    a = a + b;
    return a;
}
...
// function abs: absolute value
// abs(a,b) = sqrt(a*a+b*b);
static finline Complex4d abs(Complex4d const & a) {
#if INSTRSET >= 7  // AVX
...
// function sqrt: square root
static finline Complex4d sqrt(Complex4d const & a) {
#if INSTRSET >= 7  // AVX
...
static finline Complex4d select (Vec4db const & s, Complex4d const & a, Complex4d const & b) {
...
static finline Complex2f to_single (Complex2d const & a) {
    return _mm_cvtpd_ps(a);
}

// function to_single: convert Complex4d to Complex4f
static finline Complex4f to_single (Complex4d const & a) {
#if INSTRSET >= 7  // AVX
...
static finline Complex2d to_double (Complex2f const & a) {
    return _mm_cvtps_pd(a);
}

// function to_double: convert Complex4f to Complex4d
static finline Complex4d to_double (Complex4f const & a) {
#if INSTRSET >= 7  // AVX
...
static finline Complex2f cexp (Complex2f const & a) {
    return Complex2f(__m128(cexp(Vec4f(a))));
}

static finline Complex4f cexp (Complex4f const & a) {
    return Complex4f(cexp(Vec4f(a)));
}

static finline Complex8f cexp (Complex8f const & a) {
    return Complex8f(cexp(a.get_low()), cexp(a.get_high()));
}

static finline Complex2d cexp (Complex2d const & a) {
    return Complex2d(cexp(Vec2d(a)));
}

static finline Complex4d cexp (Complex4d const & a) {
    return Complex4d(cexp(a.get_low()), cexp(a.get_high()));
}

#else   // cexp not available as library function

static finline Complex2f cexp (Complex2f const & a) {   // complex exponential function
    float xx[2], ee;
    a.store(xx);
...
static finline Complex4f cexp (Complex4f const & x) {   // complex exponential function
    float xx[4], ee[2];
    x.store(xx);
