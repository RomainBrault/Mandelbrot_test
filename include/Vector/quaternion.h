...
// operator + : add
static finline Quaternion4f operator + (Quaternion4f const & a, Quaternion4f const & b) {
    return Quaternion4f(a.to_vector() + b.to_vector());
}

// operator += : add
static finline Quaternion4f & operator += (Quaternion4f & a, Quaternion4f const & b) {
    a = a + b;
    return a;
}
...
static finline Quaternion4f operator - (Quaternion4f const & a) {
...
static finline Quaternion4f reciprocal (Quaternion4f const & a) {
...
static finline bool operator == (Quaternion4f const & a, Quaternion4f const & b) {
...
// operator + : add
static finline Quaternion4f operator + (Quaternion4f const & a, float b) {
    return _mm_add_ss(a, _mm_set_ss(b));
}

static finline Quaternion4f operator + (float a, Quaternion4f const & b) {
    return b + a;
}

static finline Quaternion4f & operator += (Quaternion4f & a, float & b) {
    a = a + b;
    return a;
}
...
static finline Quaternion4f abs(Quaternion4f const & a) {
    Vec4f sq  = _mm_mul_ps(a,a);
    float nsq = horizontal_add(sq);
    return sqrtf(nsq);
}
...
// function select
static finline Quaternion4f select (bool s, Quaternion4f const & a, Quaternion4f const & b) {
...
// operator + : add
static finline Quaternion4d operator + (Quaternion4d const & a, Quaternion4d const & b) {
    return Quaternion4d(a.to_vector() + b.to_vector());
}

// operator += : add
static finline Quaternion4d & operator += (Quaternion4d & a, Quaternion4d const & b) {
    a = a + b;
    return a;
}
...
// operator - : unary minus
static finline Quaternion4d operator - (Quaternion4d const & a) {
...
// function reciprocal: multiplicative inverse
static finline Quaternion4d reciprocal (Quaternion4d const & a) {
...
// operator == : returns true if a == b
static finline bool operator == (Quaternion4d const & a, Quaternion4d const & b) {
...
// operator + : add
static finline Quaternion4d operator + (Quaternion4d const & a, double b) {
    return a + Quaternion4d(b);
}

static finline Quaternion4d operator + (double a, Quaternion4d const & b) {
    return b + a;
}

static finline Quaternion4d & operator += (Quaternion4d & a, double & b) {
    a = a + b;
    return a;
}
...
// function abs: calculate the norm
// abs(a + b*i + c*j + d*k) = sqrt(a*a + b*B + c*c + d*d)
static finline Quaternion4d abs(Quaternion4d const & a) {
    Vec4d sq  = a.to_vector() * a.to_vector();
    double nsq = horizontal_add(sq);
    return sqrt(nsq);
}
