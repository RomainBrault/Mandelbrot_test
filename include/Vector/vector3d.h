...
// operator + : add
static finline Vec3f operator + (Vec3f const & a, Vec3f const & b) {
    return Vec3f(Vec4f(a) + Vec4f(b));
}

// operator += : add
static finline Vec3f & operator += (Vec3f & a, Vec3f const & b) {
    a = a + b;
    return a;
}
...
static finline Vec3f operator - (Vec3f const & a) {
...
static finline bool operator == (Vec3f const & a, Vec3f const & b) {
...
// operator * : multiply
static finline Vec3f operator * (Vec3f const & a, float b) {
    return _mm_mul_ps(a, _mm_set1_ps(b));
}
static finline Vec3f operator * (float a, Vec3f const & b) {
    return b * a;
}
static finline Vec3f & operator *= (Vec3f & a, float & b) {
    a = a * b;
    return a;
}
...
static finline Vec3f cross_product (Vec3f const & a, Vec3f const & b) {
...
static finline float dot_product (Vec3f const & a, Vec3f const & b) {
    Vec4f c  = (Vec4f(a) * Vec4f(b)).cutoff(3);
    return horizontal_add(c);
}

// function vector_length
static finline float vector_length (Vec3f const & a) {
    return sqrtf(dot_product(a,a));
}

// function normalize_vector
static finline Vec3f normalize_vector (Vec3f const & a) {
    return a / vector_length(a);
}

// function select
static finline Vec3f select (bool s, Vec3f const & a, Vec3f const & b) {
    return s ? a : b;
}

// function rotate
// The vector a is rotated by multiplying by the matrix defined by the three columns col0, col1, col2
static finline Vec3f rotate (Vec3f const & col0, Vec3f const & col1, Vec3f const & col2, Vec3f const & a) {
...
// operator + : add
static finline Vec3d operator + (Vec3d const & a, Vec3d const & b) {
    return Vec3d(Vec4d(a) + Vec4d(b));
}

// operator += : add
static finline Vec3d & operator += (Vec3d & a, Vec3d const & b) {
    a = a + b;
    return a;
}
...
// operator - : unary minus
static finline Vec3d operator - (Vec3d const & a) {
...
// operator == : returns true if a == b
static finline bool operator == (Vec3d const & a, Vec3d const & b) {
...
// operator * : multiply
static finline Vec3d operator * (Vec3d const & a, double b) {
    return Vec4d(a) * Vec4d(b);
}
static finline Vec3d operator * (double a, Vec3d const & b) {
    return b * a;
}
static finline Vec3d & operator *= (Vec3d & a, double & b) {
    a = a * b;
    return a;
}
...
// function cross_product
static finline Vec3d cross_product (Vec3d const & a, Vec3d const & b) {
...
// function dot_product
static finline double dot_product (Vec3d const & a, Vec3d const & b) {
    Vec4d c  = (Vec4d(a) * Vec4d(b)).cutoff(3);
    return horizontal_add(c);
}

// function vector_length
static finline double vector_length (Vec3d const & a) {
    return sqrt(dot_product(a,a));
}

// function normalize_vector
static finline Vec3d normalize_vector (Vec3d const & a) {
    return a / vector_length(a);
}

// function select
static finline Vec3d select (bool s, Vec3d const & a, Vec3d const & b) {
    return s ? a : b;
}

// function rotate
// The vector a is rotated by multiplying by the matrix defined by the three columns col0, col1, col2
static finline Vec3d rotate (Vec3d const & col0, Vec3d const & col1, Vec3d const & col2, Vec3d const & a) {
...
static finline Vec3f to_single (Vec3d const & a) {
#if INSTRSET >= 7  // AVX
...
static finline Vec3d to_double (Vec3f const & a) {
#if INSTRSET >= 7  // AVX
